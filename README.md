...
| P2 · W7 · D2 · Lab 20: 🛡️ The Quality Inspector | SAST Compliance | Unpatched IaC Vulnerabilities | PR.PT | CIS 8 | Integrity | [`tfsec-pipeline.yml`](./p2-week-07-lab-20/.github/workflows/tfsec-pipeline.yml) |
| P2 · W7 · D3 · Lab 21: 🔑 The Delivery Drone | Token Federation Trust | Long-Term Key Compromise | PR.AC | CIS 6 | Confidentiality | [`deploy.yml`](./p2-week-07-lab-21/.github/workflows/deploy.yml) |
...
* **CloudWatch Ingestion Telemetry Audit (Active Wiretap Live `REJECT` Capture):**  
  ![CloudWatch Flow Logs](./tlab-06-monitored-fortress/cloudwatch_flow_logs.png)

* **Destroy Mandate Proof (Total Asset Decommissioning & Stipend Protection):**  
  ![Destroy Verification](./tlab-06-monitored-fortress/destroy_verification.png)
