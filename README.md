...
### ⚡ Primary Focus Areas
*   **Enterprise Purple Team Automation & Continuous Adversarial Simulation** (S01–S33 / TLAB 1–11)
*   **Mobile-to-Cloud Zero Trust Pipelines** (Decoupling the Command Layer from the Compute Layer)
*   **Declarative Infrastructure as Code (Terraform HCL)** & Hardened Shift-Left CI/CD Pipelines
*   **Digital Forensics & Incident Response (DFIR)**, Threat Hunting, and Live Log Analysis (Splunk/Kibana)
*   **Cloud Security & Multi-Tenant Identity Governance** (AWS IAM Least-Privilege, OIDC Keyless Token Federation)
...
**[ EPHEMERAL COMPUTE COMPILATION LAYER — x86_64 ]**  
☁️ **GitHub Codespaces** | **Google Cloud Shell** | **AWS** | **Azure**

All laboratory environments, vulnerability scans, and Infrastructure-as-Code deployments were executed under strict physical hardware boundaries. By deploying a **Decoupled Architecture**, we run lightweight localized automation and pre-flight validation scripts natively on the mobile device, while offloading resource-heavy container fleets, SIEM indexers, and Terraform state graphs to ephemeral x86_64 cloud compute containers. 
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| S01 | System Discovery | Unmapped Asset Inventory | ID.AM | CIS 1 | Integrity | [discovery.txt](week-01/discovery.txt) |
| S02 | Access Control | Privilege Escalation | PR.AC | CIS 3 | Confidentiality | [harden.sh](week-01/harden.sh) |
| S03 | Log Parsing | SQLi / Brute Force | DE.AE | CIS 8 | Integrity | [threat_ips.txt](week-01/threat_ips.txt) |
| TLAB 1 | Clean Sweep | Active Intrusion / Persistence | RS.AN | CIS 17 | Integrity | [TLAB-01_Report.md](week-01/TLAB-01_Report.md) |
| S04 | The Wire | Network Sabotage | PR.PT | CIS 4 | Availability | [network_audit.txt](week-02/network_audit.txt) |
| S05 | Subnetting | Network Isolation | PR.NW | CIS 12 | Availability | [subnet_audit.txt](week-02/subnet_audit.txt) |
| S06 | Protocol Analysis | DNS Deception / Service Discovery | DE.CM | CIS 9 | Confidentiality | [protocol_audit.txt](week-02/protocol_audit.txt) |
| TLAB 2 | Blackout | System Sabotage / Recovery | RS.RP | CIS 17 | Availability | [tlab_report.txt](week-02/tlab_report.txt) |
| S07 | Python Sentry | Reconnaissance (Vulnerability) | ID.RA | CIS 12 | Availability | [port_check.py](week-03/port_check.py) |
...
| S13 | Automated Onboarding | Identity Provisioning | PR.AC | CIS 5 | Integrity | [onboard_engineers.ps1](week-05/onboard_engineers.ps1) |
| S14 | Policy Enforcement | Active Directory / GPO | PR.AC | CIS 5 | Integrity | [gpo_audit.txt](week-05/gpo_audit.txt) |
| S15 | Identity Integration | Cross-Platform AD Join | PR.AC | CIS 5 | Integrity | [s15_linux_prep.sh](week-05/s15_linux_prep.sh) |
| TLAB 5 | Enterprise Synthesis | Cross-Platform Integration | PR.AC | CIS 5 | Integrity | [tlab5_report.txt](week-05/tlab5_report.txt) |
...
| S26 | Poisoned Browser | XSS (Reflected & Stored) / CSRF / Cookie Theft | DE.CM | CIS 18 | Confidentiality | [xss_payloads.txt](week-09/xss_payloads.txt) |
| S27 | Invisible Logic | API BOLA (IDOR) / Business Logic Brute Force | ID.RA | CIS 16 | Confidentiality | [api_audit.log](week-09/api_audit.log) |
| TLAB 9 | Operation Omni-Portal | Chained SQLi / Stored XSS / API BOLA Full-Stack Audit | RS.AN | CIS 18 | All Tiers | [OmniPortal_Assessment.md](week-09/OmniPortal_Assessment.md) |
| S28 | The Crime Scene | DFIR Live Triage / Cryptographic Chain of Custody | RS.AN | CIS 8 | Availability | [collection_log.txt](week-10/collection_log.txt) |
| S29 | The Digital Autopsy | DFIR Disk & Memory Carving / Malware Recovery | RS.AN | CIS 8 | Integrity | [forensic_findings.md](week-10/forensic_findings.md) |
| S30 | SIEM Engineering | Threat Hunting / Privilege Escalation | DE.AE | CIS 8 | Integrity | [attack_timeline.csv](week-10/attack_timeline.csv) |
| TLAB 10 | Operation Phantom Pursuit | DFIR Full Lifecycle / C2 Detection / Disk Forensics | RS.AN | CIS 8 | All Tiers | [Incident_Response_Report.md](week-10/Incident_Response_Report.md) |
| S31 | The Barricade | Firewall & DMZ Lockdown / Lateral Movement Prevention | PR.PT | CIS 4 | Availability + Integrity | [firewall_config.sh](week-11/firewall_config.sh) |
| S32 | The Tripwire | Custom Suricata IDS Signatures / Malware Detection | DE.CM | CIS 9 | Confidentiality | [custom_ids.rules](week-11/custom_ids.rules) |
| S33 | Endpoint Detection | Ransomware Precursor (VSS Deletion) | DE.CM | CIS 8 | Availability + Integrity |[edr_policy.xml](week-11/edr_policy.xml)|
...
| **P2 · W5 · S-14**<br>The Keymaster's Ring | IAM Surgery &<br>Policy Scoping | Privilege Escalation &<br>Wildcard Hijacking | PR.AC<br>*(800-53: AC-6)* | CIS 5<br>*(CMMC: AC.L2)* | Confidentiality | [iam_surgery.tf](./p2-week-05-lab-15/iam_surgery.tf) |
| **P2 · W5 · S-15**<br>The Vault & The State | IaC State &<br>Telemetry Recovery | State Loss &<br>Orphaned Collisions | RC.RP<br>*(800-53: CP-9)* | CIS 11<br>*(CMMC: RE.L2)* | Availability | [vpc_architecture.tf](./p2-week-06-lab-16/vpc_architecture.tf) |
| **P2 · W5 · TLAB 5**<br>The Budgeted Identity | Enterprise IaC Cost &<br>Identity Controls | Financial Sabotage &<br>Unauthorized Access | PR.DS<br>*(800-53: AC-6)* | CIS 4<br>*(CMMC: AC.L2)* | All Tiers | [main.tf](./p2-tlab-05-the-budgeted-identity/main.tf)<br>[📸 Evidence](./p2-tlab-05-the-budgeted-identity/destroy_verification.png) |
| **P2 · W6 · S-16**<br>The War Room | OSI Layer<br>Environment Repair | Configuration Drift &<br>Layer-Specific Outages | DE.AE<br>*(800-53: CM-6)* | CIS 12<br>*(CMMC: CM.L2)* | Availability | [vpc_architecture.tf](./p2-week-06-lab-16/vpc_architecture.tf) |
...
| **P2 · W7 · Lab 19**<br>The Conveyor Belt | CI/CD Pipeline<br>(GitHub Actions) | Manual Config Drift &<br>Human Error | PR.AC<br>*(800-53: CM-3)* | CIS 16<br>*(CMMC: CM.L2)* | Availability | [pulse.yml](./p2-week-07-lab-19/.github/workflows/pulse.yml)<br>[📸 Evidence](./p2-week-07-lab-19/terraform_plan_proof.png) |
...
| **P2 · W10 · TLAB 10**<br>The Audit | Automated Auditing &<br>Vulnerability Triage | Public Data Exposure &<br>Unrestricted SSH Ingress Boundaries | RM.🛡️<br>*(800-53: PM-9)* | CIS 1<br>*(CMMC: RM.L2)* | All Tiers | [executive_audit_report.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-tlab-10-the-compliance-audit/executive_audit_report.pdf)<br>**Evidence:** [📸 View Section](#-p2--w10--weekend-tlab-10-the-compliance-audit--capstone-submission) |
| **P2 · W11 · Lab-31**<br>The Translation | STAR Framework & Interview Strategy | Communication Silos & Jargon Mismatch Risks | ID.RM<br>*(800-53: PM-9)* | CIS 1<br>*(CMMC: RM.L2)* | All Tiers | [star_interview_stories.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-week-11-lab-31/star_interview_stories.pdf)<br>**Evidence:** [📸 View Section](#-p2--w11--d1--s-xxxi-the-translation--lab-submission) |
| **P2 · W11 · Lab-32**<br>The Resume | Engineering Resume Metric Refactoring | Passive Professional Language & Low-Impact Resumes | ID.RM<br>*(800-53: PM-9)* | CIS 1<br>*(CMMC: RM.L2)* | Confidentiality | [gold_standard_bullets.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-week-11-lab-32/gold_standard_bullets.pdf)<br>**Evidence:** [📸 View Section](#-p2--w11--d2--s-xxxii-the-6-second-resume--lab-submission) |
---
...
| **Evidence & Data** | Automated Script Execution | 1. [Evidence 1: port_check.py](week-03/port_check.py) <br> 2. [Evidence 2: s07reflection.md](week-03/s07reflection.md) |
...
| **Evidence & Data** | IPs: 10.0.0.55 / 172.16.0.5 | 1. [Evidence 1: brute_report.txt](week-03/brute_report.txt) (Data: 10.0.0.55 / 172.16.0.5) <br> 2. [Evidence 2: monitoring_log.txt](week-11/monitoring_log.txt) (Timestamp: Tue Mar 24 23:57:04 EDT 2026) |
...
| **Evidence** | `unified_identity.png` | Infrastructure as Code [s15_win_prep.ps1](week-05/s15_win_prep.ps1) & [s15_linux_prep.sh](week-05/s15_linux_prep.sh) |
...
* [docker-compose.yml](week-04/docker-compose.yml)
...
| **Audit Logic** | Manual Log Review | **Automated Python Watchdog [dc_auditor.py](week-06/dc_auditor.py)** |
...
* **Technical Mechanics:** Executed a tiered hardening protocol including SSH configuration management (PermitRootLogin no), UFW perimeter filtering (8080/tcp), and a Python-based watchdog script [dc_auditor.py](week-06/dc_auditor.py) for high availability monitoring.
...
| **Artifact** | `ThreatProfile_CloudNano.md` | **[ThreatProfile_CloudNano.md](week-07/ThreatProfile_CloudNano.md)** |
...
| **Artifact** | `nmap_scan_results.txt` | **[nmap_scan_results.txt](week-07/nmap_scan_results.txt)** |
...
| **Submission Mechanism** | Native `session-submit` | **Cloud Pivot Bypass + Git Push** |
| **Artifact** | `remediation_plan.md` | **[remediation_plan.md](week-07/remediation_plan.md)** |
...
| **Submission Mechanism** | Native `session-submit` | **Cloud Pivot Bypass + Git Push** |
| **Artifact** | `Perimeter_Assessment.md` | **[Perimeter_Assessment.md](week-07/Perimeter_Assessment.md)** |
...
| **Submission Mechanism** | Native `session-submit` | **Cloud Pivot Bypass + Git Push** |
| **Artifact** | `sqli_report.txt` | **[sqli_report.txt](week-09/sqli_report.txt)** |
...
| **Submission Mechanism** | Native `session-submit` | **Cloud Pivot Bypass + Git Push** |
| **Artifact** | `xss_payloads.txt` | **[xss_payloads.txt](week-09/xss_payloads.txt)** |
...
| **Submission Mechanism** | Native `session-submit` | **Cloud Pivot Bypass + Git Push** |
| **Artifact** | `api_audit.log` | **[api_audit.log](week-09/api_audit.log)** |
...
| **Submission Mechanism** | Native `session-submit` | **Cloud Pivot Bypass + Git Push** |
| **Artifact** | `OmniPortal_Assessment.md` | **[OmniPortal_Assessment.md](week-09/OmniPortal_Assessment.md)** |
...
| **Submission Mechanism** | Native `session-submit` | **Cloud Pivot Bypass + Git Push** |
| **Artifact** | `collection_log.txt` | **[collection_log.txt](week-10/collection_log.txt)** |
...
| **Artifact** | `forensic_findings.md` | **[forensic_findings.md](week-10/forensic_findings.md)** |
...
| **Evidence** | firewall_config.sh           | **[firewall_config.sh](week-11/firewall_config.sh)** + screenshot |
...
*   **Core Assets Links:** 
    *   📦 **Starter Code Repository:** [grobbins-cell/TLAB10-Audit](https://github.com)
    *   📜 **Quick Fetch Blueprint:** [executive_audit_report.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-tlab-10-the-compliance-audit/executive_audit_report.pdf)
...
*   **C-Suite Executive Audit Briefing Document Check:** 
    ...
    *   📄 [executive_audit_report.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-tlab-10-the-compliance-audit/executive_audit_report.pdf)
...
*   **Core Assets Links:** 
    ...
    *   📜 **Quick Fetch Blueprint:** [star_interview_stories.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-week-11-lab-31/star_interview_stories.pdf)
...
| Data Point | Standard Cohort (Laptop/Desktop - X86) | Android Mobile Cybersecurity Workbench (Samsung Note 20 Ultra 5g - Arm64) |
| :--- | :--- | :--- |
| **Delivery Framework** | Unstructured Verbal Narratives | ReportLab Programmatic PDF Asset Compilation |
| **Narrative Focus** | Dense Terminal Execution Jargon | Metrics-Driven C-Suite Business Summaries |

*   **Technical Mechanics:** Structured real-time data monitoring scripts (`S3_BUCKET_PUBLIC_READ_PROHIBITED`) and host containment methodologies into clear oral delivery blocks timed between 60 to 90 seconds. Isolated technical anomalies, including unauthorized port 22 access gates and credential leaks, to illustrate data sovereignty enforcement boundaries. Evidence File: `p2-week-11-lab-31/star_interview_stories.pdf`
...
*   **C-Suite Executive STAR Interview Strategy Document Check:** 
    ...
    *   📄 [star_interview_stories.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-week-11-lab-31/star_interview_stories.pdf)
...
*   **Core Assets Links:** 
    ...
    *   📜 **Quick Fetch Blueprint:** [gold_standard_bullets.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-week-11-lab-32/gold_standard_bullets.pdf)
...
| Data Point | Standard Cohort (Laptop/Desktop - X86) | Android Mobile Cybersecurity Workbench (Samsung Note 20 Ultra 5g - Arm64) |
| :--- | :--- | :--- |
| **Formatting Matrix** | Static Text Processor Resumes | Programmatic PDF Compilation Engines |
| **Verbal Formula** | Passive Educational Narratives | [Action Verb] + [Technical Tool] + [Business Metric] |

*   **Technical Mechanics:** Re-engineered low-impact deployment descriptions into industry-standard bullet specifications highlighting HashiCorp Terraform (HCL) orchestration, static application security testing (SAST) pipelines, and continuous CloudTrail query forensics. Programmatically compiled the final ledger payload into a binary file format using the ReportLab engine framework natively on disk. Evidence File: `p2-week-11-lab-32/gold_standard_bullets.pdf`
...
*   **Gold Standard Refactored Resume Architecture Check:** 
    ...
    *   📄 [gold_standard_bullets.pdf](https://raw.githubusercontent.com/CK-Bachoo/IF-Cyber-Portfolio/main/p2-week-11-lab-32/gold_standard_bullets.pdf)
