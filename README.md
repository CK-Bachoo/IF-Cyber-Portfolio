...
* **Explanation:** Established secure baseline via Note 20 Ultra. Initialized Git version control and configured SSH key-based authentication for encrypted transmission to GitHub. Documented initial Linux directory traversal, file permission management, and core systems navigation.

### 🛠️ T1-M1-S02: Command Line Operations
* [Evidence: Commit f244294](https://github.com/CK-Bachoo/IF-Cyber-Portfolio/commit/f244294)
* **Explanation:** CLI proficiency. Demonstrated mastery of directory traversal, complex file manipulation, and core Linux I/O operations required for headless systems administration and remote server management.
...
* **Explanation:** Network layer analysis. Leveraged Cisco Networking Academy resources to map the OSI model and TCP/IP stack. Conducted packet analysis foundations in preparation for advanced Wireshark interrogation, achieving 0% packet loss on external ICMP tests.
...
* **Explanation:** Advanced log interrogation to identify Indicators of Compromise (IoCs). Detected unauthorized access attempts from specific external ranges and proposed technical remediation through firewall rule implementation. (IP Forensic: 10.99.88.77)
...
* **Explanation:** Infrastructure-as-Code deployment. Synchronized the local mobile workbench with curriculum dependencies strictly via Google Cloud Shell and Termux, ensuring automated permission standards across all sensitive artifacts.
...
* **Explanation:** Connectivity verification. Leveraged ip addr, ping, and ipcalc to blueprint subnetting architectures and ensure routing integrity across the mobile-to-cloud bridge. (Target: 192.168.1.200)
...
* **Explanation:** Protocol parsing via grep, awk, and sed. Utilized Wireshark-based data captures to isolate network protocol anomalies and transform raw traffic into actionable threat intelligence. (Google IP: 142.250.217.14)

---

## 🛰️ T1-M2.TLAB: Operation Blackout (Linux Hardening)
* [Evidence: harden.sh](https://github.com/CK-Bachoo/IF-Cyber-Portfolio/blob/main/harden.sh)
* **Explanation:** Initialization of Module 2 Capstone. Leveraging GitHub Codespaces for high-compute security assessments and advanced automation workflows using the Note 20 Ultra as the primary head-unit.
